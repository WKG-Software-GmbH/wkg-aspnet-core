...
public delegate ITransactionalContinuation<TResult> DatabaseRequestAction<TDbContext, TResult>(TDbContext dbContext, IScopedTransaction transaction) where TDbContext : DbContext;
...
public delegate ITransactionalContinuation DatabaseRequestAction<TDbContext>(TDbContext dbContext, IScopedTransaction transaction) where TDbContext : DbContext;
